...
class _ssm_forward(torch.autograd.Function):
    ...
    def _get_block_size(n):
        """Dynamically choose BLOCK_SIZE based on n."""
        # Minimum 32 for warp efficiency
        return max(32, min(128, triton.next_power_of_2(n)))
    ...
    def forward(ctx, s, x, Lambda):
        ...
        BLOCK_SIZE = _ssm_forward._get_block_size(n)
